\PassOptionsToPackage{
  style=authoryear,      % ACM uses author-year
  maxnames=99,
  minnames=1,
  giveninits=false,      % Full first names
  doi=true,
  url=false,
  date=year,
  sorting=nyt
...
% Fix author formatting: Firstname Middlename Lastname
\DeclareNameAlias{default}{given-family}
\DeclareNameAlias{sortname}{family-given}

% Author. Year. Title. Journal...
\renewbibmacro*{author+year}{%
  \printnames{author}%
