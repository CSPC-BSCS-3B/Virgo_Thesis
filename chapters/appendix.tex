...
\chapter{Data Collection Consent Form}
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.85\textwidth]{appendices/consent_form.jpg}
    \end{figure}

\chapter{Acknowledgment Receipt}
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.85\textwidth]{appendices/acknowledgement_receipt.jpg}
    \end{figure}
...
\chapter{Role Acceptance Form}
    ...
    \begin{figure}[ht]
        \includegraphics[width=0.85\textwidth]{appendices/roleC.jpg}
    \end{figure}

    \begin{figure}[ht]
        \includegraphics[width=0.85\textwidth]{appendices/roleG.jpg}
    \end{figure}
...
\chapter{Panel RSC (TD, POD, FOD)}
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.50\textwidth]{appendices/rscTD.jpg}
    \end{figure}
    
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.40\textwidth]{appendices/rscTD2.jpg}
    \end{figure}
...
% \includepdf[pages=1, pagecommand={}, scale=0.8]{appendices/main.pdf}

% \vspace*{1em} % Optional: pushes content towards the bottom if desired, adjust as needed
\begin{figure}[ht]
  \centering
  \includegraphics[page=1, width=\textwidth]{appendices/main.pdf}
\end{figure}
...
\centering
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.85\textwidth]{appendices/clfA.jpg}
    \end{figure}

    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.85\textwidth]{appendices/clfA2.jpg}
    \end{figure}

    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.85\textwidth]{appendices/clfC.jpg}
    \end{figure}

    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.85\textwidth]{appendices/clfC2.jpg}
    \end{figure}

    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.85\textwidth]{appendices/clfG.jpg}
    \end{figure}
