...
These result visualized using bar chart confirms effectiveness of the designed pipeline and through the usage of the metrics such as faithfulness, context precision, context recall, and answer relevancy, it fully shows the system's capability to meet the information needs and assistance to the users who primarily seek accurate and relevant information for academic purposes from the CSPC Library's thesis collection.
